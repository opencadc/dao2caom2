...
from dao2caom2 import DAOName, PRODUCT_COLLECTION
...
def test_processed(test_config):
    ...
    assert test_subject.product_id == 'dao_c122_2020_004100_v', 'wrong product id'
    assert test_subject.file_id == 'dao_c122_2020_004100_v', 'wrong file id'
    assert test_subject.source_names == ['dao_c122_2020_004100_v.fits.gz'], 'wrong source names'
    assert test_subject.destination_uris == [
        f'{test_config.scheme}:{PRODUCT_COLLECTION}/dao_c122_2020_004100_v.fits'
    ], 'wrong destination uris'
    assert (
        test_subject.file_uri == f'{test_config.scheme}:{PRODUCT_COLLECTION}/dao_c122_2020_004100_v.fits'
    ), 'wrong file uri'
...
def test_raw(test_config):
    ...
    assert test_result.source_names == [f'{test_config.scheme}:DAO/dao_c182_2018_015013.fits']
